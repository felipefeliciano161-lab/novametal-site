...
export function Header(){
  ...
  return <header className="header">
    <div className="contactTop"><div className="container contactTopInner"><span>Qualidade - Garantia - Satisfação</span><span>vendas@novametal.ind.br</span><span>+55 11 95602-5348</span></div></div><div className="container nav">
